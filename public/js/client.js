...
function logout() {//done
    window.location = '/';  //change to main page
...
function deleteArtist(btn) {
    ...
    window.location = '/deleteArtist?id=' + id;

    // res.redirect(301, '/deleteArtist?id=' + id);
...
function getArtists(str) {//done
    if (str) {
        window.location = '/getArtists?name=' + str;

        // res.redirect(301,'/getArtists?name=' + str);
        
    } else {
        window.location = '/allArtists';
        // res.redirect(301, '/getArtists?name= ');           
    }
}
